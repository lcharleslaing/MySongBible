...
const initialFormState: FormState = {
  packageName: "my-song-bible",
  appVersion: "0.1.0",
  appDisplayName: "My Song Bible",
  sidebarShowIcon: true,
  sidebarShowEyebrow: true,
  sidebarShowTitle: true,
  sidebarShowDescription: true,
  sidebarEyebrow: "My Song Bible",
  sidebarTitle: "Song Workspace",
  sidebarDescription: "Local-first workspace for songs, voice notes, and creative study.",
  topbarShowEyebrow: true,
  topbarShowTitle: true,
  topbarEyebrow: "Local-First Workspace",
  topbarTitle: "My Song Bible",
  homeShowEyebrow: true,
  homeShowTitle: true,
  homeShowDescription: true,
  homeEyebrow: "Overview",
  homeTitle: "My Song Bible",
  homeDescription: "A local-first workspace for capturing, reviewing, and organizing song ideas with voice-enabled tools.",
  deviceName: "",
  selectedDeviceName: "",
  whisperBinaryPath: "",
  whisperModelPath: "",
  ...
  sqliteDatabasePath: "./data/my_song_bible.sqlite3",
